...
const styles = StyleSheet.create({
  ...
  input: { backgroundColor: "#fff", padding: 12, borderRadius: 12, borderWidth: 1, borderColor: "#ddd", fontSize: 14 },
  error: { color: "red", marginTop: 4, fontSize: 12 },
  recordButton: { backgroundColor: "#2E8B8B", paddingVertical: 12, paddingHorizontal: 20, borderRadius: 12, alignItems: "center", marginBottom: 6 },
